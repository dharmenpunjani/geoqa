...
public class StanfordNERComponent extends QanaryComponent {
    ...
    public QanaryMessage process(QanaryMessage myQanaryMessage) throws Exception {
        ...
        props.put("classifier", "CRFCLassifier");
        // Create a new pipline
        
        StanfordCoreNLP pipeline = new StanfordCoreNLP(props);
        // Create an empty annotation just with the given text
//        pipeline.addAnnotator(new TokensRegexNERAnnotator(namedEn, true));
        Annotation document = new Annotation(lemmatize(myQuestion));
